...
if __name__ == "__main__" : 
	...
	gui.title(" ToDo - Võ Thế Duy [43.01.104.032]") 

	# set the configuration of GUI window 
	gui.geometry("400x450")

	# create a label : Enter Your Task 
	enterTask = Label(gui, text = "Thêm việc cần làm", font = "lucida 16")

	# create a text entry box 
	# for typing the task 
	enterTaskField = Entry(gui, font = "lucida 14", width = 26)

	# create a Submit Button and place into the root window 
	# when user press the button, the command or 
	# function affiliated to that button is executed 
	Submit = Button(gui, text = "Submit", font = "lucida 16 bold", fg = "Black", bg = "Green", command = insertTask) 

	# create a text area for the root 
	# with lunida 13 font 
	# text area is for writing the content 
	TextArea = Text(gui, height = 10, width = 36, font = "lucida 14")

	# create a label : Delete Task Number 
	taskNumber = Label(gui, text = "\nDelete Task Number")
						
	taskNumberField = Text(gui, height = 1, width = 5, font = "lucida 16")

	# create a Delete Button and place into the root window 
	# when user press the button, the command or 
	# function affiliated to that button is executed . 
	delete = Button(gui, text = "Delete", font = "lucida 16", fg = "Black", bg = "Red", command = delete)

	# create a Exit Button and place into the root window 
	# when user press the button, the command or 
	# function affiliated to that button is executed . 
	Exit = Button(gui, text = "Exit", font = "lucida 16", fg = "Black", bg = "Red", command = exit)
